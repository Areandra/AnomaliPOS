...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.restaurant.driver' => 'string',
            'auth.guards.restaurant.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.restaurant.driver' => 'string',
            'auth.providers.restaurant.model' => 'string',
            ...
            'filesystems.links./home/areandra/Project/AnomaliPOS/public/storage' => 'string',
...
'auth.guards.web.provider','auth.guards.restaurant.driver','auth.guards.restaurant.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.restaurant.driver','auth.providers.restaurant.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
...
'filesystems.disks.s3.report','filesystems.links./home/areandra/Project/AnomaliPOS/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.serialization','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','blade-lucide-icons.prefix','blade-lucide-icons.fallback','blade-lucide-icons.class',
...
'signed','throttle','verified','auth.restaurant','trusted.device',);
        registerArgumentsSet('routes', 'register-form','account-activation','login','verify_device','change-restaurant-pin',
'request-change-password-form','request-change-password','change-password','users.index',
'users.create','users.store','users.edit','users.update','users.destroy',
'users.toggle-status','users.update-password','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.activation-progres','auth.device-verification','auth.login','auth.register','auth.request-reset-password-form',
'auth.reset-password','auth.reset-pin','auth.restaurant-pin','components.admin-layout','components.device-detected-modal',
'components.notification','emails.activation-account','emails.reset-password','errors.bill-closed','errors.forbidden',
'errors.not-found','errors.server-error','layouts.app','layouts.auth','users.create',
'users.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'MAIL_SCHEME','MAIL_HOST','MAIL_PORT','MAIL_ENCRYPTION','MAIL_USERNAME',
