...
@section('title', 'Reset PIN Restoran')
...
>
    ...
    <template x-if="isDark">
        <div class="fixed inset-0 pointer-events-none opacity-20">
            <div class="absolute top-0 left-0 w-125 h-125 rounded-full blur-[120px] mix-blend-screen bg-blue-900"></div>
            <div class="absolute bottom-0 right-0 w-125 h-125 rounded-full blur-[120px] mix-blend-screen bg-indigo-900"></div>
        </div>
    </template>
    ...
    <div class="relative z-10 max-w-sm w-full">
        ...
        <div class="flex justify-center mb-8">
            <div
                :class="isDark ? 'bg-blue-500/10 border-blue-500/20 text-blue-500' : 'bg-blue-50 border-blue-100 text-blue-600'"
            ...
            >
                ...
                <div
                    :class="isDark ? 'bg-slate-800 text-blue-500' : 'bg-white text-blue-600'"
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2">
                <div class="relative">
                    <input
                        ...
                        maxlength="6"
                        x-model="form.pin"
                        @input="form.pin = $event.target.value.replace(/\D/g, '')"
                    ...
                    />
                    <i data-lucide="lock" class="absolute left-4 top-1/2 -translate-y-1/2 opacity-20 w-[18px] h-[18px]"></i>
                </div>
            ...
            <div class="space-y-2">
                ...
                <template x-if="errors.pin_confirmation">
                    <p class="text-red-500 text-[10px] font-bold uppercase text-center" x-text="errors.pin_confirmation"></p>
                </template>
            </div>
