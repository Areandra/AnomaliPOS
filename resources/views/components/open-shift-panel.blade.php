@props([
    'action' => '/sign-out', // URL untuk tombol sign out
    'isDark' => true, // Default tema (bisa dioverride saat pemanggilan)
])
...
<div class="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex justify-center items-center z-[100] p-4 lg:p-6 overflow-hidden select-none"
    x-data="openShiftPanel({ isDark: {{ $isDark ? 'true' : 'false' }} })">
    ...
    <div class="flex flex-col lg:flex-row w-full max-w-5xl h-full max-h-[800px] gap-4 transition-all duration-500">
        ...
        <div class="flex-[1.7] flex flex-col rounded-[2.5rem] border overflow-hidden shadow-2xl"
            ...
            <div class="px-8 py-6 border-b border-white/5 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[9px] font-bold opacity-30 uppercase mt-1 tracking-tighter">Inisialisasi Kas Awal
                        </p>
                    </div>
                </div>
            ...
            <div
                class="flex-1 p-8 lg:p-12 flex flex-col justify-center space-y-10 min-h-0 overflow-y-auto scrollbar-hide">
                <div class="text-center space-y-4">
                    <div class="p-10 rounded-[3rem] border-2 border-dashed transition-all"
                        ...
                        <span class="text-[10px] font-black opacity-40 uppercase tracking-[0.2em]">Modal Terhitung di
                            Laci</span>
        ...
        <div class="flex-1 flex flex-col gap-4">
            <div class="p-8 rounded-[2.5rem] border-2 border-dashed flex items-start gap-5"
                ...
                <div class="p-3 rounded-xl shrink-0"
                    :class="isDark ? 'bg-black/20 text-amber-500' : 'bg-white text-orange-600 shadow-sm'">
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-[11px] leading-relaxed font-bold opacity-50">
                        Harap hitung fisik uang tunai di laci kasir dengan teliti sebelum memulai transaksi. Angka ini
                        akan menjadi saldo awal sistem.
                    </p>
                </div>
            </div>
                ...
                <template x-for="btn in [1,2,3,4,5,6,7,8,9,'C',0,'DEL']" :key="btn">
                    <button
                        ...
                        :class="typeof btn === 'number'
                            ?
                            (isDark ? 'bg-white/5 hover:bg-white/10 text-white' :
