<x-app-layout title="Bill Closed">
    ...
    <x-auth-page glow-from="bg-purple-900" glow-to="bg-blue-900">
        ...
        const timer = setInterval(() => {
            ...
            <div class="flex justify-center mb-8">
                <div :class="$store.theme.isDark ? 'bg-amber-500/10 border-amber-500/20 text-amber-500' :
                    ...
                    <div :class="$store.theme.isDark ? 'bg-slate-800 text-amber-500' : 'bg-white text-orange-600'"
            ...
            <div :class="$store.theme.isDark ? 'bg-amber-500/20' : 'bg-orange-200'"
                class="h-1 w-12 mx-auto rounded-full mb-6"></div>
            ...
            <p class="text-xs font-medium leading-relaxed mb-10 px-4 opacity-50 italic">
                Tagihan pada sesi ini sudah ditutup. Silakan hubungi kasir untuk mengaktifkan kembali meja Anda sebelum
                memesan lagi.
            </p>
            ...
            <div :class="$store.theme.isDark ? 'bg-slate-900/50 border-white/10 shadow-2xl' :
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <span :class="$store.theme.isDark ? 'text-amber-500' : 'text-orange-600'"
                            class="text-3xl font-black italic" x-text="'0' + count"></span>
                ...
                <div :class="$store.theme.isDark ? 'bg-white/5' : 'bg-slate-100'"
                    class="mt-4 h-1.5 w-full rounded-full overflow-hidden">
            ...
            {{-- SKIP --}}
            <button @click="window.location.href = '/order/session/{{ $sessionToken }}'"
