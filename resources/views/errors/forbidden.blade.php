...
>
    ...
    <div class="relative z-10 max-w-sm w-full text-center">
        ...
        <p class="text-xs font-medium leading-relaxed mb-12 px-6 opacity-50 italic">
            Maaf, Anda tidak memiliki izin yang cukup untuk mengakses halaman ini. Sesi Anda mungkin tidak valid atau terbatas.
        </p>
        ...
        >
            <div class="flex items-center justify-between mb-4">
                ...
                <span
                    ...
                    class="text-4xl font-black italic"
                    x-text="'0' + count"
                ></span>
            </div>

            <div :class="$store.theme.isDark ? 'bg-white/5' : 'bg-slate-100'" class="h-1.5 w-full rounded-full overflow-hidden">
                <div
