    ...
    <div class="sticky top-0 z-40 w-full px-8 py-4 backdrop-blur-xl border-b transition-all duration-300 bg-white/70 border-gray-200/50 dark:bg-slate-900/70 dark:border-white/5">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-6 mx-auto w-full">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="font-bold text-lg leading-none tracking-tight dark:text-white">
                        User Management
                    </h1>
            ...
            <div class="flex items-center gap-4 w-full md:w-auto">
                ...
                <div class="flex items-center gap-3 flex-1 p-3 px-5 border rounded-full transition-all shadow-sm bg-white border-gray-200 focus-within:border-orange-500 dark:bg-slate-900 dark:border-white/10 dark:focus-within:border-amber-500/50">
                    ...
                    <button
                        ...
                        <template x-if="isDark">
                            <x-lucide-sun class="w-[18px] h-[18px]" />
                        </template>

                        <template x-if="!isDark">
                            <x-lucide-moon class="w-[18px] h-[18px]" />
                        </template>
    ...
    <div class="p-8 mx-auto w-full flex-1 overflow-y-auto pb-32 bg-gray-50/30 dark:bg-transparent [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <template x-for="u in filteredUsers" :key="u.id">
                ...
                <div class="group relative p-6 rounded-3xl border transition-all duration-300 hover:-translate-y-1 bg-white border-gray-100 hover:shadow-xl shadow-gray-200/50 dark:bg-slate-900/50 dark:border-white/5 dark:hover:bg-slate-800 dark:shadow-2xl dark:shadow-black/20">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        {{-- NAME --}}
                        <h3
                            class="text-sm font-black uppercase tracking-tight mb-1 text-slate-800 dark:text-white"
                            x-text="u.name">
                        </h3>
                        ...
                        <div class="flex items-center justify-between w-full mb-6">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-[8px] font-black uppercase opacity-40 mb-0.5 text-slate-900 dark:text-white">
                                    Member Since
                                </p>
                            ...
                            <div class="text-right">
                                ...
                                <span
                                    class="text-[10px] font-black uppercase text-orange-600 dark:text-amber-500"
                                    x-text="u.role || 'User'">
                                </span>
        ...
        <template x-if="filteredUsers.length === 0">
            ...
            <div class="flex flex-col items-center justify-center py-20 opacity-30">
                ...
                <p class="font-black uppercase tracking-widest text-xs dark:text-white">
                    No users found
                </p>
        ...
        Alpine.data('userIndex', () => ({
            ...
            get filteredUsers() {
                ...
                return this.users.filter(u => {
                    ...
                    return u.name.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
